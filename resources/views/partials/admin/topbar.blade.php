            ...
            <div class="d-flex">
                ...
                <div class="navbar-brand-box horizontal-logo">
                    <a href="index.html" class="logo logo-dark">
                        <span class="logo-sm">
                            <img src="{{ asset('assets/images/logo-sm.png') }}" alt="" height="222">
                        </span>
                        <span class="logo-lg">
                    ...
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown"
                        ...
                        <span class="d-flex align-items-center">
                            ...
                            <span class="text-start ms-xl-2">
                                ...
                                <span class="d-none d-xl-block ms-1 fs-12 text-muted user-name-sub-text text-capitalize">{{ Auth::user()->getRoleNames()->first() }}</span>
                            </span>
                        </span>
                    </button>
                    <div class="dropdown-menu dropdown-menu-end">
                        <!-- item-->
                        <h6 class="dropdown-header">{{ __('message.welcome_back', ['data' => Auth::user()->name]) }}</h6>
                        <a class="dropdown-item" href="{{ route('admin.profile.index') }}"><i
                                class="mdi mdi-account-circle text-muted fs-16 align-middle me-1"></i> <span
                                class="align-middle">{{ __('vocab.profile') }}</span></a>
                        ...
                        <form action="{{ route('login.logout') }}" method="POST">
                            ...
                            <button class="dropdown-item"><i
                                    ...
                                    class="align-middle" data-key="t-logout">{{ __('vocab.logout') }}</span></button>
                        </form>
